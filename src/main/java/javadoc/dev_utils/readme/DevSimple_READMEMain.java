 ...
 * @author Ttt
 */
final class DevSimple_READMEMain {

    private DevSimple_READMEMain() {
    }

    /**
     * 创建 DevSimple - README 头部前缀
    ...
    public static String createREADME() {
        // 包名
        final String packageName = ApiConfig.DEV_SIMPLE_PACKAGE;
        // 本地文件路径
        final String path = ApiConfig.DEV_SIMPLE_PATH;
        // Github 链接地址
        final String githubUrl = ApiConfig.DEV_SIMPLE_GITHUB_URL;
        ...
        // 添加头部信息
        createREADMEHead(
                builder, path, packageName, ApiConfig.sCatalogMap_Simple,
                ApiConfig.DEV_SIMPLE_TEMPLATE
        );

        // 保存合成后的 API README
        FileUtils.saveFile(
                new File(
                        ApiConfig.DEV_SIMPLE_API_FILE_SAVE_PATH,
        ...
        resultBuilder.append("\n");
        resultBuilder.append("\n");
        resultBuilder.append("保存地址: " + ApiConfig.DEV_SIMPLE_API_FILE_SAVE_PATH + ApiConfig.README_FILE_NAME);
        resultBuilder.append("\n");
        return resultBuilder.toString();
    }

    public static void main(String[] args) {
        System.out.println(DevSimple_READMEMain.createREADME());
    }
}