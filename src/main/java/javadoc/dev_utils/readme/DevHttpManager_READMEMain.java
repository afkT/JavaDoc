 ...
 * @author Ttt
 */
final class DevHttpManager_READMEMain {

    private DevHttpManager_READMEMain() {
    }

    /**
     * 创建 DevHttpManager - README 头部前缀
    ...
    public static String createREADME() {
        // 包名
        final String packageName = ApiConfig.DEV_HTTP_MANAGER_PACKAGE;
        // 本地文件路径
        final String path = ApiConfig.DEV_HTTP_MANAGER_PATH;
        // Github 链接地址
        final String githubUrl = ApiConfig.DEV_HTTP_MANAGER_GITHUB_URL;
        ...
        FileUtils.saveFile(
                new File(
                        ApiConfig.DEV_HTTP_MANAGER_API_FILE_SAVE_PATH,
                        ApiConfig.README_FILE_NAME
                ).getAbsolutePath(), builder.toString().getBytes()
        );

//        // 方法名重复记录存储
//        Utils.saveFile(ApiConfig.DEV_HTTP_MANAGER_API_FILE_SAVE_PATH, "readme_method_repeat_api.md", methodRepeatBuilder.toString());
//        // 方法没有注释记录存储
//        Utils.saveFile(ApiConfig.DEV_HTTP_MANAGER_API_FILE_SAVE_PATH, "readme_method_not_annotate_api.md", methodNotAnnotateBuilder.toString());
//        // 类不存在方法记录存储
//        Utils.saveFile(ApiConfig.DEV_HTTP_MANAGER_API_FILE_SAVE_PATH, "readme_not_method_api.md", notMethodBuilder.toString());
        ...
        resultBuilder.append("\n");
        resultBuilder.append("\n");
        resultBuilder.append("保存地址: " + ApiConfig.DEV_HTTP_MANAGER_API_FILE_SAVE_PATH + ApiConfig.README_FILE_NAME);
        resultBuilder.append("\n");
        return resultBuilder.toString();
    }

    public static void main(String[] args) {
        System.out.println(DevHttpManager_READMEMain.createREADME());
    }
}