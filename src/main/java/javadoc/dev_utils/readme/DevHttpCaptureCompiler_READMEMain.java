...
final class DevHttpCaptureCompiler_READMEMain {
    ...
    public static String createREADME() {
        ...
        // 添加头部信息
        createREADMEHead(
                buffer, path, packageName, ApiConfig.sCatalogMap_HttpCapture,
...
//        // 方法名重复记录存储
//        Utils.saveFile(ApiConfig.DEV_HTTP_CAPTURE_COMPILER_API_FILE_SAVE_PATH, "readme_method_repeat_api.md", methodRepeatBuffer.toString());
//        // 方法没有注释记录存储
//        Utils.saveFile(ApiConfig.DEV_HTTP_CAPTURE_COMPILER_API_FILE_SAVE_PATH, "readme_method_not_annotate_api.md", methodNotAnnotateBuffer.toString());
//        // 类不存在方法记录存储
//        Utils.saveFile(ApiConfig.DEV_HTTP_CAPTURE_COMPILER_API_FILE_SAVE_PATH, "readme_not_method_api.md", notMethodBuffer.toString());
        ...
        resultBuffer.append("\n");
        resultBuffer.append("\n");
        resultBuffer.append("保存地址: " + ApiConfig.DEV_HTTP_CAPTURE_COMPILER_API_FILE_SAVE_PATH + ApiConfig.README_FILE_NAME);
        resultBuffer.append("\n");
