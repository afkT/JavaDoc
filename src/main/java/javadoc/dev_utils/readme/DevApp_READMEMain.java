...
final class DevApp_READMEMain {
    ...
    private static void createREADMEHead(final StringBuffer buffer, final String path, final String packageName,
        ...
        buffer.append("\n");
        buffer.append("\n");
        buffer.append("// dev.utils.app - APP 打印日志工具类");
        buffer.append("\n");
...
//        // 方法没有注释记录存储
//        Utils.saveFile(ApiConfig.FILE_SAVE_PATH, "readme_method_not_annotate_api.md", methodNotAnnotateBuffer.toString());
//        // 类不存在方法记录存储
//        Utils.saveFile(ApiConfig.FILE_SAVE_PATH, "readme_not_method_api.md", notMethodBuffer.toString());
