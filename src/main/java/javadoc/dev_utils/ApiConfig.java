...
public final class ApiConfig {
    ...
    // DevApp 版本号
    public static final String DEV_APP_VERSION            = "2.1.2";
    ...
    // DevAssist 版本号
    public static final String DEV_ASSIST_VERSION            = "1.0.6";
    ...
    // DevWidget 版本号
    public static final String DEV_WIDGET_VERSION            = "1.0.6";
