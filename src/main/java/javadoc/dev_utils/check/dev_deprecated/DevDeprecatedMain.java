 ...
 * @author Ttt
 */
public final class DevDeprecatedMain {

    private DevDeprecatedMain() {
    }
    ...
    public static LinkedHashMap<String, HashMap<String, List<String>>> checker(
        ...
        // 检测路径
        String path = ApiConfig.DEV_DEPRECATED_UTILS_PATH;
        // 代码检测分析配置接口
        ICheckConfig iCheckConfig = new DevDeprecatedConfig();
        // 是否使用 List<File>
        ...
        // 执行检测
        return CheckMain.execute(DevDeprecatedMain.class, new CheckInfo(path, iCheckConfig)
