...
final class DevDeprecatedConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("IToastImpl", ArrayUtils.asListArgs("filter","normalizeToastContent"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("IToastImpl", ArrayUtils.asListArgs("reset","setUseHandler","setNullText","setTextLength","initialize","style","defaultStyle","getToastStyle","initStyle","initToastFilter","setView","show","show","show","show","cancel","filter","normalizeToastContent","getThreadToastStyle","createView","dispatchTextToast","newToastText","dispatchViewToast","newToastView"));
        ignoreStaticMap.put("PermissionUtils", ArrayUtils.asListArgs("setPermissionCallback","setRequestPermissionsResult","request","request","onRequestPermissionsResultCommon","checkPermissions","requestCallback","getPermissionsStatus"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("IToast.Filter", ArrayUtils.asListArgs("filter","normalizeToastContent"));
        ...
        ignoreUnPublicMap.put("IToastImpl", ArrayUtils.asListArgs("getThreadToastStyle","createView","dispatchTextToast","newToastText","dispatchViewToast","newToastView"));
        ...
        ignoreUnPublicMap.put("ToastTintUtils.Filter", ArrayUtils.asListArgs("filter","normalizeToastContent"));
        ...
        ignoreUnPublicMap.put("ToastUtils", ArrayUtils.asListArgs("dispatchTextToast","handlerToastRes","handlerToastStr","reflectToastHandler"));
        ignoreUnPublicMap.put("ToastUtils.Filter", ArrayUtils.asListArgs("filter","normalizeToastContent"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("IToastImpl", ArrayUtils.asListArgs("reset - void","setUseHandler - void","setNullText - void","setTextLength - void","initialize - void","initStyle - void","initToastFilter - void","setView - void","show - void","show - void","show - void","show - void","cancel - void","dispatchTextToast - void","dispatchViewToast - void"));
        ...
        ignoreReturnVoidMap.put("ToastUtils", ArrayUtils.asListArgs("reset - void","setToastFilter - void","setUseHandler - void","setNullText - void","setUseConfig - void","setGravity - void","setMargin - void","showShort - void","showShort - void","showShort - void","showShort - void","showLong - void","showLong - void","showLong - void","showLong - void","showToast - void","showToast - void","showToast - void","showToast - void","showShortNew - void","showShortNew - void","showShortNew - void","showShortNew - void","showLongNew - void","showLongNew - void","showLongNew - void","showLongNew - void","showToastNew - void","showToastNew - void","showToastNew - void","showToastNew - void","dispatchTextToast - void","showToastView - void","showToastView - void","showToastView - void","showToastView - void","showToastView - void","handlerToastRes - void","handlerToastStr - void","reflectToastHandler - void"));
