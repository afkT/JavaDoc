 ...
 * @author Ttt
 */
public class DevBaseMVVMMain {

    public static void main(String[] args) {
        // 检测路径
        String path = ApiConfig.DEV_BASE_MVVM_PATH;
        // 代码检测分析配置接口
        ICheckConfig iCheckConfig = new DevBaseMVVMConfig();
        // 是否覆盖文件内容
        ...
        // 执行检测
        CheckMain.execute(DevBaseMVVMMain.class, new CheckInfo(path, iCheckConfig)
