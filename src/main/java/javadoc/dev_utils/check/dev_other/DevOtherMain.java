 ...
 * @author Ttt
 */
public final class DevOtherMain {

    private DevOtherMain() {
    }
    ...
    public static LinkedHashMap<String, HashMap<String, List<String>>> checker(
        ...
        // 代码检测分析配置接口
        ICheckConfig iCheckConfig = new DevOtherConfig();
        // 是否使用 List<File>
        ...
        // 执行检测
        return CheckMain.execute(DevOtherMain.class, new CheckInfo(path, iCheckConfig)
