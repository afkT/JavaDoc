...
final class DevOtherConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("WifiVo", ArrayUtils.asListArgs("describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("WifiVo", ArrayUtils.asListArgs("describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel","describeContents","writeToParcel"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("WifiVo", ArrayUtils.asListArgs("writeToParcel","writeToParcel","writeToParcel","writeToParcel","writeToParcel","writeToParcel","writeToParcel","writeToParcel","writeToParcel","writeToParcel"));
