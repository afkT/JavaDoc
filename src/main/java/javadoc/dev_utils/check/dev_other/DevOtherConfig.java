...
final class DevOtherConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("WebViewAssist.Builder", ArrayUtils.asListArgs("setWebViewAssist","applyPri","setWebViewAssist","applyPri"));
        ignoreUnPublicMap.put("WebViewAssist.Builder.OnApplyListener", ArrayUtils.asListArgs("onApply","onApply"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("WebViewAssist", ArrayUtils.asListArgs("setGlobalBuilder - void","removeCookie - void","setGlobalBuilder - void","removeCookie - void"));
        ignoreReturnVoidMap.put("WebViewAssist.Builder.OnApplyListener", ArrayUtils.asListArgs("onApply - void","onApply - void"));
