...
final class DevOtherConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("LuckGlideEngineImpl", ArrayUtils.asListArgs("createGlideEngine","assertValidRequest","isDestroy"));
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("LuckGlideEngineImpl", ArrayUtils.asListArgs("loadImage","loadImage","loadFolderImage","loadGridImage","assertValidRequest","isDestroy"));
        ...
        ignoreFinalMap.put("PictureSelectorUtils", ArrayUtils.asListArgs("openCamera","openCamera","openCamera","openCamera","openGallery","openGallery","openGallery","openGallery","setConfig","setSavePath","setMinimumCompressSize","deleteCacheDirFile","deleteAllCacheDirFile","isMediaSelectorResult","getSelectors","getSelectorPaths","getSingleSelector","getSingleSelectorPath"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("LuckGlideEngineImpl", ArrayUtils.asListArgs("loadImage","loadImage","loadFolderImage","loadGridImage","assertValidRequest","isDestroy"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("LuckGlideEngineImpl", ArrayUtils.asListArgs("assertValidRequest","isDestroy"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("LuckGlideEngineImpl", ArrayUtils.asListArgs("assertValidRequest","isDestroy"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("LuckGlideEngineImpl", ArrayUtils.asListArgs("loadImage - void","loadImage - void","loadFolderImage - void","loadGridImage - void"));
