...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("TimeKeeper", Utils.asListArgs("waitForEndAsyn","waitForEnd"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("HttpURLConnectionUtils", Utils.asListArgs("doGetAsyn - void","doPostAsyn - void","request - void","getNetTime - void","getNetTime - void","reqNetTime - void"));
        ...
        ignoreReturnVoidMap.put("TimeKeeper", Utils.asListArgs("waitForEndAsyn - void","waitForEnd - void"));
