...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("WifiHotUtils", ArrayUtils.asListArgs("stratWifiAp","closeWifiAp","getWifiApState","getWifiApConfiguration","setWifiApConfiguration","isOpenWifiAp","closeWifiApCheck","isConnectHot","getHotspotServiceIp","getHotspotAllotIp","getConnectHotspotMsg","getHotspotSplitIpMask","intToString","getApWifiSSID","getApWifiPwd","setOnWifiAPListener"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("IDCardUtils", ArrayUtils.asListArgs("convertCharToInt","validateDateSmllerThenNow","isNumber"));
        ...
        ignoreUnPublicMap.put("ImageConvertUtils.BMP", ArrayUtils.asListArgs("addBMPImageHeader","addBMPImageInfosHeader","addBMP_ARGB_8888"));
