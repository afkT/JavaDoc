...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("DevHelper", ArrayUtils.asListArgs("quickHelper","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable","setAnimationRepeat","setAnimationListener","startAnimation","cancelAnimation"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("DevHelper", ArrayUtils.asListArgs("devHelper","quickHelper","viewHelper","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable","setAnimationRepeat","setAnimationListener","startAnimation","cancelAnimation"));
        ...
        ignoreStaticMap.put("FloatingWindowManagerAssist2", ArrayUtils.asListArgs("removeFloatingView","addFloatingView","removeAllFloatingView","isNeedsAdd","setNeedsAdd","getAttachActivity","getMapFloatingKey","getMapFloatingView","getMapFloatingViewLayoutParams"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("IFloatingOperate", ArrayUtils.asListArgs("removeFloatingView","addFloatingView","removeAllFloatingView","isNeedsAdd","setNeedsAdd"));
        ...
        ignoreUnPublicMap.put("IHelperByDev", ArrayUtils.asListArgs("setAnimationRepeat","setAnimationListener","startAnimation","cancelAnimation"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("FloatingWindowManagerAssist2", ArrayUtils.asListArgs("removeAllFloatingView - void","setNeedsAdd - void"));
        ...
        ignoreReturnVoidMap.put("IFloatingOperate", ArrayUtils.asListArgs("removeAllFloatingView - void","setNeedsAdd - void"));
