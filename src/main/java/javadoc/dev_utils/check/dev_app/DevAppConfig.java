...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("ColorUtils.ColorInfo.ColorParser", ArrayUtils.asListArgs("normalizeColorInput"));
        ...
        ignoreAnnotateMap.put("WindowsExplorerStringSimpleComparator", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","getSplitFileName"));
        ignoreAnnotateMap.put("WindowsExplorerStringSimpleComparator2", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","splitStringPreserveDelimiter"));
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("AllLowerCaseInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("AllowCharsInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("AlphanumericInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("AppRecordInsert", ArrayUtils.asListArgs("setFileInfo"));
        ignoreFinalMap.put("AsciiPrintableInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("ByteLengthInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("ChineseAddressInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("ChineseIdCardInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("ChineseMobilePhoneInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("ChineseNameInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("ChineseOnlyInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("ChinesePostalCodeInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("ColorUtils.ColorInfo", ArrayUtils.asListArgs("RGBtoHSB"));
        ignoreFinalMap.put("ColorUtils.ColorInfo.ColorParser", ArrayUtils.asListArgs("normalizeColorInput"));
        ...
        ignoreFinalMap.put("DecimalInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("DelegateInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("EmailInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("EmojiInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("FlowHelper", ArrayUtils.asListArgs("flow","postRunnable","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable"));
        ...
        ignoreFinalMap.put("FrontSpaceInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("HalfWidthInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("HexInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("IntegerInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("LettersOnlyInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("RecyclerViewUtils.TopSnappedSmoothScroller", ArrayUtils.asListArgs("calculateDyToMakeVisible"));
        ignoreFinalMap.put("RegexInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("SearchKeywordInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("SignedDecimalInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("SignedIntegerInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("TagInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("TrimTrailingSpaceInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("TypeUtils.ParameterizedTypeImpl", ArrayUtils.asListArgs("equals"));
        ignoreFinalMap.put("UrlInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreFinalMap.put("UsernameInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreFinalMap.put("WindowsExplorerStringSimpleComparator", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","getSplitFileName"));
        ignoreFinalMap.put("WindowsExplorerStringSimpleComparator2", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","splitStringPreserveDelimiter"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("ActivityLifecycleAssist", ArrayUtils.asListArgs("getActivityLifecycle","getActivityLifecycleNotify","getTopActivity","setActivityLifecycleFilter","setAbstractActivityLifecycle","registerActivityLifecycleCallbacks","unregisterActivityLifecycleCallbacks"));
        ...
        ignoreStaticMap.put("AllLowerCaseInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("AllowCharsInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("AlphanumericInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("AsciiPrintableInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("BeepVibrateAssist", ArrayUtils.asListArgs("isPlayBeep","isVibrate","setVibrate","setVibrate","setMediaPlayer","playBeepSoundAndVibrate","close","shouldBeep","streamUpdate"));
        ...
        ignoreStaticMap.put("ByteLengthInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("ChineseAddressInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("ChineseIdCardInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("ChineseMobilePhoneInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("ChineseNameInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("ChineseOnlyInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("ChinesePostalCodeInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("ColorUtils.ColorInfo", ArrayUtils.asListArgs("getKey","getValue","getValueParser","getValueColor","getAlpha","getRed","getGreen","getBlue","getGrayLevel","getHue","getSaturation","getBrightness","toString","parseColorValueIntoChannels"));
        ignoreStaticMap.put("ColorUtils.ColorInfo.ColorParser", ArrayUtils.asListArgs("normalizeColorInput"));
        ...
        ignoreStaticMap.put("DecimalInputFilter", ArrayUtils.asListArgs("filter","isValidDecimal"));
        ignoreStaticMap.put("DelayAssist", ArrayUtils.asListArgs("remove","post","post","setDelayMillis","setCallback"));
        ignoreStaticMap.put("DelegateInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("DevCacheManager", ArrayUtils.asListArgs("calculateCacheSizeAndCacheCount","getCachePath","remove","removeForKeys","contains","isDue","clear","clearDue","clearType","getItemByKey","getKeys","getPermanentKeys","getCount","getSize","put","put","put","put","put","put","put","put","put","put","put","put","getInt","getLong","getFloat","getDouble","getBoolean","getString","getBytes","getBitmap","getDrawable","getSerializable","getParcelable","getJSONObject","getJSONArray","getInt","getLong","getFloat","getDouble","getBoolean","getString","getBytes","getBitmap","getDrawable","getSerializable","getParcelable","getJSONObject","getJSONArray","dataFileForKey","configFileForKey","keyEntryFilesExist","getOrPopulateCachedData","formatDataJson","readDataFromDisk","writeTypedPayload","readDecryptedPayload"));
        ignoreStaticMap.put("DevFloatingCommon", ArrayUtils.asListArgs("update","getView","getEvent","getListener","getDownTime","getPoint","getFirstPoint","getDelayAssist","actionDown","actionMove","actionUp","onClick","onLongClick","getDiffTime","isValidTime","isValidClickByTime","isValidLongClickByTime","postLongClick","onDelayed"));
        ...
        ignoreStaticMap.put("EmailInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("EmojiInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("FlowHelper", ArrayUtils.asListArgs("flow","postRunnable","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable"));
        ...
        ignoreStaticMap.put("FrontSpaceInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("HalfWidthInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("HexInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("IntegerInputFilter", ArrayUtils.asListArgs("filter","isValidInteger"));
        ...
        ignoreStaticMap.put("LettersOnlyInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("MaxLinesInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("MaxValueInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("MinValueInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("NoChineseInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("NoConsecutiveSpaceInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("NoEnterInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("NoLeadingZeroIntegerInputFilter", ArrayUtils.asListArgs("filter","isValid"));
        ignoreStaticMap.put("NoSpaceInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("PercentageInputFilter", ArrayUtils.asListArgs("filter","isValidPercentage","isValidDecimalPart"));
        ignoreStaticMap.put("PortInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("PrintablePasswordInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("ProhibitCharsInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("QuickHelper", ArrayUtils.asListArgs("getView","targetView","targetViewGroup","targetImageView","targetTextView","targetEditText","targetRecyclerView","flow","postRunnable","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable","addTouchArea","addTouchArea","setOnClick","setOnLongClick","setOnTouch","setId","setClipChildren","removeAllViews","addView","addView","addView","addView","addView","setLayoutParams","setWidthHeight","setWidthHeight","setWeight","setWidth","setWidth","setHeight","setHeight","setMinimumWidth","setMinimumHeight","setAlpha","setTag","setScrollX","setScrollY","setDescendantFocusability","setOverScrollMode","setHorizontalScrollBarEnabled","setVerticalScrollBarEnabled","setScrollContainer","setClipToOutline","setOutlineProvider","setOutlineProviderClip","setNextFocusForwardId","setNextFocusDownId","setNextFocusLeftId","setNextFocusRightId","setNextFocusUpId","setRotation","setRotationX","setRotationY","setScaleX","setScaleY","setTextAlignment","setTextDirection","setPivotX","setPivotY","setTranslationX","setTranslationY","setX","setY","setLayerType","requestLayout","requestFocus","clearFocus","setFocusableInTouchMode","setFocusable","toggleFocusable","setSelected","toggleSelected","setEnabled","toggleEnabled","setClickable","toggleClickable","setLongClickable","toggleLongClickable","setChecked","toggleChecked","setActivated","toggleActivated","setPressed","togglePressed","setVisibilitys","setVisibilitys","setVisibilityINs","toggleVisibilitys","toggleVisibilitys","reverseVisibilitys","reverseVisibilitys","toggleViews","viewVisible","viewVisibles","viewGone","viewGones","viewInVisible","viewInVisibles","removeSelfFromParent","requestLayoutParent","measureView","measureView","setLayoutGravity","setLayoutGravity","setMarginLeft","setMarginLeft","setMarginTop","setMarginTop","setMarginRight","setMarginRight","setMarginBottom","setMarginBottom","setMargin","setMargin","setMargin","setPaddingLeft","setPaddingLeft","setPaddingTop","setPaddingTop","setPaddingRight","setPaddingRight","setPaddingBottom","setPaddingBottom","setPadding","setPadding","setPadding","addRules","addRules","removeRules","setAnimation","clearAnimation","startAnimation","startAnimation","cancelAnimation","setBackground","setBackgroundColor","setBackgroundResource","setBackgroundTintList","setBackgroundTintMode","setForeground","setForegroundGravity","setForegroundTintList","setForegroundTintMode","removeBackground","removeAllBackground","removeForeground","setColorFilter","setColorFilter","setColorFilter","setColorFilter","setProgressDrawable","setBarProgress","setBarMax","setBarValue","smoothScrollToPosition","scrollToPosition","smoothScrollToTop","scrollToTop","smoothScrollToBottom","scrollToBottom","smoothScrollTo","smoothScrollBy","fullScroll","scrollTo","scrollBy","setAdjustViewBounds","setMaxHeight","setMaxWidth","setImageLevel","setImageBitmap","setImageDrawable","setImageResource","setImageMatrix","setImageTintList","setImageTintMode","removeImageBitmap","removeImageDrawable","setScaleType","setBackgroundResources","setBackgroundResources","setImageResources","setImageResources","setImageBitmaps","setImageBitmaps","setImageDrawables","setImageDrawables","removeImageBitmaps","removeImageBitmaps","removeImageDrawables","removeImageDrawables","setScaleTypes","setScaleTypes","setText","setMaxLength","setMaxLengthAndText","setFilters","appendFilters","clearFilters","mergeFilters","setInputType","setImeOptions","setTransformationMethod","setText","insert","insert","setCursorVisible","setTextCursorDrawable","setTextCursorDrawable","setSelectionToTop","setSelectionToBottom","setSelection","setTransformationMethod","addTextChangedListener","removeTextChangedListener","setKeyListener","setHint","setHintTextColors","setHintTextColors","setTextColors","setTextColors","setHtmlTexts","setTypeface","setTypeface","setTextSizeByPx","setTextSizeBySp","setTextSizeByDp","setTextSizeByIn","setTextSize","clearFlags","setPaintFlags","setAntiAliasFlag","setBold","setBold","setBold","setUnderlineText","setUnderlineText","setStrikeThruText","setStrikeThruText","setLetterSpacing","setLineSpacing","setLineSpacingAndMultiplier","setTextScaleX","setIncludeFontPadding","setLines","setMaxLines","setMinLines","setMaxEms","setMinEms","setEms","setEllipsize","setAutoLinkMask","setAllCaps","setGravity","setCompoundDrawablePadding","setCompoundDrawablesByLeft","setCompoundDrawablesByTop","setCompoundDrawablesByRight","setCompoundDrawablesByBottom","setCompoundDrawables","setCompoundDrawablesWithIntrinsicBoundsByLeft","setCompoundDrawablesWithIntrinsicBoundsByTop","setCompoundDrawablesWithIntrinsicBoundsByRight","setCompoundDrawablesWithIntrinsicBoundsByBottom","setCompoundDrawablesWithIntrinsicBounds","setAutoSizeTextTypeWithDefaults","setAutoSizeTextTypeUniformWithConfiguration","setAutoSizeTextTypeUniformWithPresetSizes","setLayoutManager","setSpanCount","setOrientation","setAdapter","notifyItemRemoved","notifyItemInserted","notifyItemMoved","notifyDataSetChanged","attachLinearSnapHelper","attachPagerSnapHelper","addItemDecoration","addItemDecoration","removeItemDecoration","removeItemDecorationAt","removeAllItemDecoration","setOnScrollListener","addOnScrollListener","removeOnScrollListener","clearOnScrollListeners","setNestedScrollingEnabled","forceGetViewSize"));
        ignoreStaticMap.put("ROMUtils.RomInfo", ArrayUtils.asListArgs("getName","getVersion","toString"));
        ignoreStaticMap.put("RangeValueInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("RecordConfig", ArrayUtils.asListArgs("getStoragePath","getFileName","getFolderName","getFileIntervalTime","isRecordingEnabled","setRecordingEnabled","isInsertHeaderData","setInsertHeaderData","getRecordInsert","getRecordInsert","setRecordInsert","getFinalPath","getIntervalTimeFolder"));
        ...
        ignoreStaticMap.put("RecyclerViewUtils.EndSnappedSmoothScroller", ArrayUtils.asListArgs("getVerticalSnapPreference","calculateDyToMakeVisible"));
        ...
        ignoreStaticMap.put("RecyclerViewUtils.TopSnappedSmoothScroller", ArrayUtils.asListArgs("getVerticalSnapPreference","calculateDyToMakeVisible"));
        ...
        ignoreStaticMap.put("SearchKeywordInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("ShellUtils.CommandResult", ArrayUtils.asListArgs("isSuccess","isSuccessWithoutErrorOutput","isSuccessWithSuccessOutput","isSuccessOutputContaining"));
        ignoreStaticMap.put("SignedDecimalInputFilter", ArrayUtils.asListArgs("filter","isValidSignedDecimal","isValidDecimalPart"));
        ignoreStaticMap.put("SignedIntegerInputFilter", ArrayUtils.asListArgs("filter","isValidSignedInteger"));
        ignoreStaticMap.put("SnackbarUtils", ArrayUtils.asListArgs("getStyle","setStyle","getSnackbar","getSnackbarView","getTextView","getActionButton","getSnackbarLayout","getSnackbarContentLayout","addView","addView","setCallback","setAction","setAction","setAction","setAction","dismiss","dismiss","showShort","showLong","showIndefinite","showShort","showLong","showIndefinite","dispatchSnackbar","setSnackbarStyle","setSnackbarStyle","getShadowMargin","setShadowMargin","isAutoCalc","setAutoCalc","clearLocations","above","below","setSnackbarLocation","setLayoutGravity","setMargin"));
        ...
        ignoreStaticMap.put("TagInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("ThisActivityLifecycleAssist.ActivityLifecycleImpl", ArrayUtils.asListArgs("onActivityCreated","onActivityStarted","onActivityResumed","onActivityPaused","onActivityStopped","onActivitySaveInstanceState","onActivityDestroyed","onActivityPreCreated","onActivityPostCreated","onActivityPreStarted","onActivityPostStarted","onActivityPreResumed","onActivityPostResumed","onActivityPrePaused","onActivityPostPaused","onActivityPreStopped","onActivityPostStopped","onActivityPreSaveInstanceState","onActivityPostSaveInstanceState","onActivityPreDestroyed","onActivityPostDestroyed","listenerOrEmpty","ofListener","addListener","removeListener","removeAllListener"));
        ...
        ignoreStaticMap.put("TrimTrailingSpaceInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("UrlInputFilter", ArrayUtils.asListArgs("filter"));
        ignoreStaticMap.put("UsernameInputFilter", ArrayUtils.asListArgs("filter"));
        ...
        ignoreStaticMap.put("ViewHelper", ArrayUtils.asListArgs("flow","postRunnable","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable","addTouchArea","addTouchArea","setOnClick","setOnLongClick","setOnTouch","setId","setClipChildren","removeAllViews","addView","addView","addView","addView","addView","setLayoutParams","setWidthHeight","setWidthHeight","setWeight","setWidth","setWidth","setHeight","setHeight","setMinimumWidth","setMinimumHeight","setAlpha","setTag","setScrollX","setScrollY","setDescendantFocusability","setOverScrollMode","setHorizontalScrollBarEnabled","setVerticalScrollBarEnabled","setScrollContainer","setClipToOutline","setOutlineProvider","setOutlineProviderClip","setNextFocusForwardId","setNextFocusDownId","setNextFocusLeftId","setNextFocusRightId","setNextFocusUpId","setRotation","setRotationX","setRotationY","setScaleX","setScaleY","setTextAlignment","setTextDirection","setPivotX","setPivotY","setTranslationX","setTranslationY","setX","setY","setLayerType","requestLayout","requestFocus","clearFocus","setFocusableInTouchMode","setFocusable","toggleFocusable","setSelected","toggleSelected","setEnabled","toggleEnabled","setClickable","toggleClickable","setLongClickable","toggleLongClickable","setChecked","toggleChecked","setActivated","toggleActivated","setPressed","togglePressed","setVisibilitys","setVisibilitys","setVisibilityINs","toggleVisibilitys","toggleVisibilitys","toggleVisibilitys","reverseVisibilitys","reverseVisibilitys","reverseVisibilitys","reverseVisibilitys","toggleViews","viewVisible","viewVisibles","viewGone","viewGones","viewInVisible","viewInVisibles","removeSelfFromParent","requestLayoutParent","measureView","measureView","setLayoutGravity","setLayoutGravity","setMarginLeft","setMarginLeft","setMarginTop","setMarginTop","setMarginRight","setMarginRight","setMarginBottom","setMarginBottom","setMargin","setMargin","setMargin","setPaddingLeft","setPaddingLeft","setPaddingTop","setPaddingTop","setPaddingRight","setPaddingRight","setPaddingBottom","setPaddingBottom","setPadding","setPadding","setPadding","addRules","addRules","removeRules","setAnimation","clearAnimation","startAnimation","startAnimation","cancelAnimation","setBackground","setBackgroundColor","setBackgroundResource","setBackgroundTintList","setBackgroundTintMode","setForeground","setForegroundGravity","setForegroundTintList","setForegroundTintMode","removeBackground","removeAllBackground","removeForeground","setColorFilter","setColorFilter","setColorFilter","setColorFilter","setProgressDrawable","setBarProgress","setBarMax","setBarValue","smoothScrollToPosition","scrollToPosition","smoothScrollToTop","scrollToTop","smoothScrollToBottom","scrollToBottom","smoothScrollTo","smoothScrollBy","fullScroll","scrollTo","scrollBy","setAdjustViewBounds","setMaxHeight","setMaxWidth","setImageLevel","setImageBitmap","setImageDrawable","setImageResource","setImageMatrix","setImageTintList","setImageTintMode","removeImageBitmap","removeImageDrawable","setScaleType","setBackgroundResources","setBackgroundResources","setImageResources","setImageResources","setImageBitmaps","setImageBitmaps","setImageDrawables","setImageDrawables","removeImageBitmaps","removeImageBitmaps","removeImageDrawables","removeImageDrawables","setScaleTypes","setScaleTypes","setText","setMaxLength","setMaxLengthAndText","setFilters","appendFilters","clearFilters","mergeFilters","setInputType","setImeOptions","setTransformationMethod","setTransformationMethod","setText","insert","insert","setCursorVisible","setTextCursorDrawable","setTextCursorDrawable","setSelectionToTop","setSelectionToBottom","setSelection","setTransformationMethod","addTextChangedListener","removeTextChangedListener","setKeyListener","setKeyListener","setKeyListener","setHint","setHintTextColors","setHintTextColors","setTextColors","setTextColors","setHtmlTexts","setTypeface","setTypeface","setTextSizeByPx","setTextSizeBySp","setTextSizeByDp","setTextSizeByIn","setTextSize","clearFlags","setPaintFlags","setAntiAliasFlag","setBold","setBold","setBold","setUnderlineText","setUnderlineText","setStrikeThruText","setStrikeThruText","setLetterSpacing","setLineSpacing","setLineSpacingAndMultiplier","setTextScaleX","setIncludeFontPadding","setLines","setMaxLines","setMinLines","setMaxEms","setMinEms","setEms","setEllipsize","setAutoLinkMask","setAllCaps","setGravity","setCompoundDrawablePadding","setCompoundDrawablesByLeft","setCompoundDrawablesByTop","setCompoundDrawablesByRight","setCompoundDrawablesByBottom","setCompoundDrawables","setCompoundDrawablesWithIntrinsicBoundsByLeft","setCompoundDrawablesWithIntrinsicBoundsByTop","setCompoundDrawablesWithIntrinsicBoundsByRight","setCompoundDrawablesWithIntrinsicBoundsByBottom","setCompoundDrawablesWithIntrinsicBounds","setAutoSizeTextTypeWithDefaults","setAutoSizeTextTypeUniformWithConfiguration","setAutoSizeTextTypeUniformWithPresetSizes","setLayoutManager","setSpanCount","setSpanCount","setOrientation","setAdapter","notifyItemRemoved","notifyItemInserted","notifyItemMoved","notifyDataSetChanged","attachLinearSnapHelper","attachPagerSnapHelper","addItemDecoration","addItemDecoration","removeItemDecoration","removeItemDecorationAt","removeAllItemDecoration","setOnScrollListener","addOnScrollListener","removeOnScrollListener","clearOnScrollListeners","setNestedScrollingEnabled","forceGetViewSize"));
        ...
        ignoreStaticMap.put("WindowsExplorerStringSimpleComparator", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","getSplitFileName"));
        ignoreStaticMap.put("WindowsExplorerStringSimpleComparator2", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","splitStringPreserveDelimiter"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("ColorUtils.ColorInfo.ColorParser", ArrayUtils.asListArgs("normalizeColorInput"));
        ...
        ignoreParamMap.put("DevFloatingCommon", ArrayUtils.asListArgs("onDelayed"));
        ...
        ignoreParamMap.put("ImageUtils", ArrayUtils.asListArgs("drawableToBitmap"));
        ...
        ignoreParamMap.put("WindowsExplorerStringSimpleComparator", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","getSplitFileName"));
        ignoreParamMap.put("WindowsExplorerStringSimpleComparator2", ArrayUtils.asListArgs("compare","compareExplorerStyleNames","splitStringPreserveDelimiter"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("AccessibilityUtils.Node", ArrayUtils.asListArgs("performAction","performAction","performClick","performClick","performLongClick","performLongClick","recursiveNodeChild"));
        ignoreUnPublicMap.put("AccessibilityUtils.NodeFilter", ArrayUtils.asListArgs("accept"));
        ...
        ignoreUnPublicMap.put("ChineseIdCardInputFilter", ArrayUtils.asListArgs("isAllowedAt"));
        ignoreUnPublicMap.put("ChineseMobilePhoneInputFilter", ArrayUtils.asListArgs("isAllowedAt"));
        ignoreUnPublicMap.put("ChinesePostalCodeInputFilter", ArrayUtils.asListArgs("isValidChinesePostalCode"));
        ...
        ignoreUnPublicMap.put("ColorUtils", ArrayUtils.asListArgs("parseColorStringToArgb"));
        ignoreUnPublicMap.put("ColorUtils.ColorInfo", ArrayUtils.asListArgs("parseColorValueIntoChannels","RGBtoHSB"));
        ignoreUnPublicMap.put("ColorUtils.ColorInfo.Parser", ArrayUtils.asListArgs("normalizeColorInput"));
        ...
        ignoreUnPublicMap.put("CrashUtils.CrashCatchListener", ArrayUtils.asListArgs("onThrowableCaptured","uncaughtException"));
        ignoreUnPublicMap.put("DateSort", ArrayUtils.asListArgs("getDateSortValue"));
        ignoreUnPublicMap.put("DecimalInputFilter", ArrayUtils.asListArgs("isValidDecimal"));
        ignoreUnPublicMap.put("Decrypt", ArrayUtils.asListArgs("decrypt"));
        ignoreUnPublicMap.put("DelayAssist.Callback", ArrayUtils.asListArgs("onDelayed"));
        ignoreUnPublicMap.put("DevCache.Data", ArrayUtils.asListArgs("setType","setSaveTime","setValidTime"));
        ignoreUnPublicMap.put("DevCacheManager", ArrayUtils.asListArgs("calculateCacheSizeAndCacheCount","dataFileForKey","configFileForKey","keyEntryFilesExist","getOrPopulateCachedData","formatDataJson","readDataFromDisk","writeTypedPayload","readDecryptedPayload"));
        ...
        ignoreUnPublicMap.put("DevTimer.Callback", ArrayUtils.asListArgs("onTick"));
        ...
        ignoreUnPublicMap.put("DownloadUtils", ArrayUtils.asListArgs("extractRowMapFromCursor"));
        ...
        ignoreUnPublicMap.put("FileBreadthFirstSearchUtils.SearchHandler", ArrayUtils.asListArgs("shouldVisitFile","shouldCollectFile","onSearchComplete"));
        ignoreUnPublicMap.put("FileDepthFirstSearchUtils", ArrayUtils.asListArgs("queryFile"));
        ignoreUnPublicMap.put("FileDepthFirstSearchUtils.SearchHandler", ArrayUtils.asListArgs("shouldVisitFile","shouldCollectFile","onSearchComplete"));
        ignoreUnPublicMap.put("FileRecordUtils", ArrayUtils.asListArgs("concatInsertLog","concatLog","finalRecord"));
        ignoreUnPublicMap.put("FileRecordUtils.Callback", ArrayUtils.asListArgs("onRecordCompleted"));
        ...
        ignoreUnPublicMap.put("InputFilterCharUtils.CharPredicate", ArrayUtils.asListArgs("test"));
        ignoreUnPublicMap.put("InputFilterCharUtils.FullTextValidator", ArrayUtils.asListArgs("test"));
        ignoreUnPublicMap.put("InputFilterCharUtils.PositionCharPredicate", ArrayUtils.asListArgs("isAllowedAt"));
        ignoreUnPublicMap.put("InputFilterUtils", ArrayUtils.asListArgs("addDistinct","putByClass","singleLineBaseFilters","multiLineBaseFilters"));
        ignoreUnPublicMap.put("IntSort", ArrayUtils.asListArgs("getIntSortValue"));
        ignoreUnPublicMap.put("IntegerInputFilter", ArrayUtils.asListArgs("isValidInteger"));
        ...
        ignoreUnPublicMap.put("JobSchedulerUtils", ArrayUtils.asListArgs("resolveScheduler"));
        ...
        ignoreUnPublicMap.put("MaxLinesInputFilter", ArrayUtils.asListArgs("countLineBreaks"));
        ignoreUnPublicMap.put("NoLeadingZeroIntegerInputFilter", ArrayUtils.asListArgs("isValid"));
        ignoreUnPublicMap.put("NotificationUtils.Callback", ArrayUtils.asListArgs("customizeNotification"));
        ...
        ignoreUnPublicMap.put("PercentageInputFilter", ArrayUtils.asListArgs("isValidPercentage","isValidDecimalPart"));
        ignoreUnPublicMap.put("PortInputFilter", ArrayUtils.asListArgs("isValidPort"));
        ignoreUnPublicMap.put("PreferenceImpl", ArrayUtils.asListArgs("put","getValue"));
        ignoreUnPublicMap.put("ROMUtils", ArrayUtils.asListArgs("isRightRom","checkHarmonyOS","getManufacturer","getBrand","getRomVersion","getSystemProperty","getSystemPropertyByShell","getSystemPropertyByStream","getSystemPropertyByReflect","detectRomProfile"));
        ignoreUnPublicMap.put("RecordConfig", ArrayUtils.asListArgs("getIntervalTimeFolder"));
        ignoreUnPublicMap.put("RecyclerViewUtils.EndSnappedSmoothScroller", ArrayUtils.asListArgs("getVerticalSnapPreference"));
        ignoreUnPublicMap.put("RecyclerViewUtils.TopSnappedSmoothScroller", ArrayUtils.asListArgs("getVerticalSnapPreference"));
        ...
        ignoreUnPublicMap.put("ResourceColor", ArrayUtils.asListArgs("getInstance","loadCachedIntColor","loadCachedIntColorByResName","loadCachedArgbStringColor"));
        ...
        ignoreUnPublicMap.put("SignedDecimalInputFilter", ArrayUtils.asListArgs("isValidSignedDecimal","isValidDecimalPart"));
        ignoreUnPublicMap.put("SignedIntegerInputFilter", ArrayUtils.asListArgs("isValidSignedInteger"));
        ignoreUnPublicMap.put("SizeUtils.OnGetSizeListener", ArrayUtils.asListArgs("onGetSize"));
        ignoreUnPublicMap.put("SnackbarUtils", ArrayUtils.asListArgs("dispatchSnackbar","clearLocations","setSnackbarLocation","setLayoutGravity","setMargin"));
        ...
        ignoreUnPublicMap.put("StreamUtils.WriteCallback", ArrayUtils.asListArgs("onStart","onProgress","onError","onFinish","onEnd"));
        ignoreUnPublicMap.put("StringSort", ArrayUtils.asListArgs("getStringSortValue"));
        ignoreUnPublicMap.put("ThisActivityLifecycleAssist.ActivityLifecycleImpl", ArrayUtils.asListArgs("listenerOrEmpty"));
        ...
        ignoreUnPublicMap.put("WallpaperUtils.OnOtherCallback", ArrayUtils.asListArgs("trySetWallpaper"));
        ignoreUnPublicMap.put("WindowAssist", ArrayUtils.asListArgs("getInstance"));
        ignoreUnPublicMap.put("WindowsExplorerStringSimpleComparator", ArrayUtils.asListArgs("compareExplorerStyleNames","getSplitFileName"));
        ignoreUnPublicMap.put("WindowsExplorerStringSimpleComparator2", ArrayUtils.asListArgs("compareExplorerStyleNames","splitStringPreserveDelimiter"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("AccessibilityUtils", ArrayUtils.asListArgs("setService - void"));
        ignoreReturnVoidMap.put("AccessibilityUtils.Node", ArrayUtils.asListArgs("recursiveNodeChild - void"));
        ...
        ignoreReturnVoidMap.put("BeepVibrateAssist", ArrayUtils.asListArgs("close - void","streamUpdate - void"));
        ...
        ignoreReturnVoidMap.put("ColorUtils.ColorInfo", ArrayUtils.asListArgs("parseColorValueIntoChannels - void"));
        ...
        ignoreReturnVoidMap.put("CrashUtils.CrashCatchListener", ArrayUtils.asListArgs("onThrowableCaptured - void","uncaughtException - void"));
        ...
        ignoreReturnVoidMap.put("DelayAssist.Callback", ArrayUtils.asListArgs("onDelayed - void"));
        ...
        ignoreReturnVoidMap.put("DevTimer.Callback", ArrayUtils.asListArgs("onTick - void"));
        ...
        ignoreReturnVoidMap.put("FileBreadthFirstSearchUtils.SearchHandler", ArrayUtils.asListArgs("onSearchComplete - void"));
        ignoreReturnVoidMap.put("FileDepthFirstSearchUtils", ArrayUtils.asListArgs("stop - void","query - void","queryFile - void"));
        ignoreReturnVoidMap.put("FileDepthFirstSearchUtils.SearchHandler", ArrayUtils.asListArgs("onSearchComplete - void"));
        ignoreReturnVoidMap.put("FileIOUtils", ArrayUtils.asListArgs("setBufferSize - void"));
        ignoreReturnVoidMap.put("FileRecordUtils", ArrayUtils.asListArgs("setRecordingEnabled - void","setRecordInsert - void","setCallback - void"));
        ignoreReturnVoidMap.put("FileRecordUtils.Callback", ArrayUtils.asListArgs("onRecordCompleted - void"));
        ...
        ignoreReturnVoidMap.put("HandlerUtils", ArrayUtils.asListArgs("postRunnable - void","postRunnable - void","postRunnable - void","postRunnable - void","postRunnable - void","removeRunnable - void","clearRunnableMaps - void","postRunnable - void","removeRunnable - void"));
        ignoreReturnVoidMap.put("HandlerUtils.OnEndListener", ArrayUtils.asListArgs("onEnd - void"));
        ignoreReturnVoidMap.put("HttpURLConnectionUtils", ArrayUtils.asListArgs("doGetAsync - void","doPostAsync - void","request - void","getNetTime - void","reqNetTime - void"));
        ...
        ignoreReturnVoidMap.put("InputFilterUtils", ArrayUtils.asListArgs("addDistinct - void","putByClass - void"));
        ignoreReturnVoidMap.put("JCLogUtils", ArrayUtils.asListArgs("setPrintLog - void","setControlPrintLog - void","printLog - void","d - void","e - void","e - void","e - void","i - void","xml - void","dTag - void","eTag - void","eTag - void","eTag - void","iTag - void","xmlTag - void","setPrint - void"));
        ignoreReturnVoidMap.put("JCLogUtils.Print", ArrayUtils.asListArgs("printLog - void"));
        ignoreReturnVoidMap.put("KeyBoardUtils", ArrayUtils.asListArgs("setDelayMillis - void","attachHideKeyboardOnOutsideEditTouch - void","fixSoftInputLeaks - void"));
        ...
        ignoreReturnVoidMap.put("LogPrintUtils", ArrayUtils.asListArgs("setPrintLog - void","printLog - void","d - void","e - void","e - void","e - void","w - void","i - void","v - void","wtf - void","json - void","xml - void","dTag - void","eTag - void","eTag - void","eTag - void","wTag - void","iTag - void","vTag - void","wtfTag - void","jsonTag - void","xmlTag - void","setPrint - void"));
        ...
        ignoreReturnVoidMap.put("NotificationUtils.Callback", ArrayUtils.asListArgs("customizeNotification - void"));
        ...
        ignoreReturnVoidMap.put("ScreenshotUtils", ArrayUtils.asListArgs("dispatchLatestMediaChangeToChecker - void"));
        ...
        ignoreReturnVoidMap.put("SnackbarUtils", ArrayUtils.asListArgs("dismiss - void","dismiss - void","showShort - void","showLong - void","showIndefinite - void","showShort - void","showLong - void","showIndefinite - void","dispatchSnackbar - void","clearLocations - void","setSnackbarLocation - void"));
        ...
        ignoreReturnVoidMap.put("StreamUtils.WriteCallback", ArrayUtils.asListArgs("onStart - void","onProgress - void","onError - void","onFinish - void","onEnd - void"));
        ...
        ignoreReturnVoidMap.put("ViewUtils", ArrayUtils.asListArgs("viewVisible - void","viewVisibles - void","viewGone - void","viewGones - void","viewInVisible - void","viewInVisibles - void"));
