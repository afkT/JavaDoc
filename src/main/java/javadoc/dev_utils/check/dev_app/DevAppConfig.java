...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("DevFinal.ARRAY", ArrayUtils.asListArgs("getHexDigits","getHexDigitsUpper","getNumbers","getLowerCaseLetters","getCapitalLetters","getLetters","getNumbersAndLetters","getZodiac","getConstellationDate","getConstellation"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("NotificationUtils.Callback", ArrayUtils.asListArgs("customizeNotification"));
