...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("DevHelper", ArrayUtils.asListArgs("quickHelper","postRunnable","postRunnable","postRunnable","postRunnable","removeRunnable"));
