...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("Operateable.Operate", ArrayUtils.asListArgs("execute"));
        ignoreAnnotateMap.put("Operateable.OperateByParam", ArrayUtils.asListArgs("execute"));
        ignoreAnnotateMap.put("Operateable.OperateByParam2", ArrayUtils.asListArgs("execute"));
        ignoreAnnotateMap.put("Operateable.OperateByParam3", ArrayUtils.asListArgs("execute"));
        ignoreAnnotateMap.put("Operateable.OperateByParamArgs", ArrayUtils.asListArgs("execute"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("Operateable.OperateByParam", ArrayUtils.asListArgs("execute"));
        ignoreParamMap.put("Operateable.OperateByParam2", ArrayUtils.asListArgs("execute"));
        ignoreParamMap.put("Operateable.OperateByParam3", ArrayUtils.asListArgs("execute"));
        ignoreParamMap.put("Operateable.OperateByParamArgs", ArrayUtils.asListArgs("execute"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("Operateable.Operate", ArrayUtils.asListArgs("execute"));
        ignoreUnPublicMap.put("Operateable.OperateByParam", ArrayUtils.asListArgs("execute"));
        ignoreUnPublicMap.put("Operateable.OperateByParam2", ArrayUtils.asListArgs("execute"));
        ignoreUnPublicMap.put("Operateable.OperateByParam3", ArrayUtils.asListArgs("execute"));
        ignoreUnPublicMap.put("Operateable.OperateByParamArgs", ArrayUtils.asListArgs("execute"));
