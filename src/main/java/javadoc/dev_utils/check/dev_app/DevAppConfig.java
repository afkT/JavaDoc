...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("IPreference", ArrayUtils.asListArgs("put","putAll","putAll","putAll","get","getAll","getAll","remove","removeAll","removeAll","contains","clear","getInt","getLong","getFloat","getDouble","getBoolean","getString","getSet","getInt","getLong","getFloat","getDouble","getBoolean","getString","getSet"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("TimerManager", ArrayUtils.asListArgs("addContainsChecker - void","recycle - void","closeAll - void","closeAllNotRunning - void","closeAllInfinite - void","closeAllTag - void","closeAllUUID - void"));
