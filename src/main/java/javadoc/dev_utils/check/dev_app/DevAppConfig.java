...
final class DevAppConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("ResourceColor", ArrayUtils.asListArgs("getColor","getColor","getColorById","getColorById","getColorByARGB","getColorByARGB","_getIntColor","_getIntColorById","_getStringColor"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("ResourceColor", ArrayUtils.asListArgs("getInstance","_getIntColor","_getIntColorById","_getStringColor"));
