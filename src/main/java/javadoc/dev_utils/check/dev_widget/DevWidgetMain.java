...
class DevWidgetMain {
    ...
    public static void main(String[] args) {
        // 本地文件路径
        String path = ApiConfig.DEV_WIDGET_PATH;
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodUnAnnotateMap, DevWidgetConfig.sIgnoreAnnotateMap);
        // 转换 JSON 数据 - 缺少注释的方法
        ...
        // 忽略处理
        MapUtils.removeToMap(sParamUnFinalMap, DevWidgetConfig.sIgnoreFinalMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodUnStaticMap, DevWidgetConfig.sIgnoreStaticMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodLackParamMap, DevWidgetConfig.sIgnoreParamMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodLackReturnMap, DevWidgetConfig.sIgnoreReturnMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodUnPublicMap, DevWidgetConfig.sIgnoreUnPublicMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sNoModifierVariableMap, DevWidgetConfig.sIgnoreModifierVariableMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodReturnVoidMap, DevWidgetConfig.sIgnoreReturnVoidMap);
