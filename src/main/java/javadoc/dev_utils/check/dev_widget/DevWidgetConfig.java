...
final class DevWidgetConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("FlowLikeView.CurveUpdateListener", ArrayUtils.asListArgs("onAnimationUpdate"));
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("FlowLikeView.CurveUpdateListener", ArrayUtils.asListArgs("onAnimationUpdate"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("FlowLikeView.CurveUpdateListener", ArrayUtils.asListArgs("onAnimationUpdate"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("FlowLikeView.CurveUpdateListener", ArrayUtils.asListArgs("onAnimationUpdate"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("RadiusAttrs", ArrayUtils.asListArgs("resetRadius","clearCornerRadiusState"));
        ...
        ignoreUnPublicMap.put("ViewAssist", ArrayUtils.asListArgs("obtainViewForType","resetWrapperAndAdapters","applyDisplayModeChange","registerTypeAdapter","unregisterTypeAdapter","switchVisibleAdapterType","refreshAdapterBindingForType"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("RadiusAttrs", ArrayUtils.asListArgs("resetRadius - void","clearCornerRadiusState - void","onSizeChanged - void"));
        ...
        ignoreReturnVoidMap.put("ScanShapeView", ArrayUtils.asListArgs("initialize - void","applyCornerPathEffect - void","destroy - void","refPaintToAnnulus - void","makeBackground - void","makeAnim - void","drawAnim - void","resetAnim - void","startAnim - void","stopAnim - void","animSwitch - void","refLineColorToSquare - void","refLineColorToHexagon - void","refLineColorToAnnulus - void","initAnim - void"));
        ignoreReturnVoidMap.put("SignView", ArrayUtils.asListArgs("prepareBlankCanvas - void"));
        ignoreReturnVoidMap.put("StateLayout", ArrayUtils.asListArgs("initialize - void"));
        ignoreReturnVoidMap.put("ViewAssist", ArrayUtils.asListArgs("showType - void","showType - void","switchVisibleAdapterType - void"));
