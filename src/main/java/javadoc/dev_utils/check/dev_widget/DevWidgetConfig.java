...
final class DevWidgetConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("FirstLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreAnnotateMap.put("FirstLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ...
        ignoreAnnotateMap.put("LastLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreAnnotateMap.put("LastLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreAnnotateMap.put("LimitLayout", ArrayUtils.asListArgs("onMeasure"));
        ignoreAnnotateMap.put("LineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreAnnotateMap.put("LineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("BaseItemDecoration", ArrayUtils.asListArgs("setSingleLineDraw","setLineLeft","setLineRight","setLineLeftRight"));
        ...
        ignoreFinalMap.put("FirstLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreFinalMap.put("FirstLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ...
        ignoreFinalMap.put("LastLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreFinalMap.put("LastLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreFinalMap.put("LimitLayout", ArrayUtils.asListArgs("initAttrs","onMeasure","setMaxWidth","setMaxHeight"));
        ignoreFinalMap.put("LineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreFinalMap.put("LineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("BaseItemDecoration", ArrayUtils.asListArgs("getLinePaint","isSingleLineDraw","setSingleLineDraw","getLineLeft","setLineLeft","getLineRight","setLineRight","setLineLeftRight"));
        ...
        ignoreStaticMap.put("FirstLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreStaticMap.put("FirstLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ...
        ignoreStaticMap.put("LastLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreStaticMap.put("LastLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ...
        ignoreStaticMap.put("LineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreStaticMap.put("LineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("FirstLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreParamMap.put("FirstLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ...
        ignoreParamMap.put("LastLineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreParamMap.put("LastLineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreParamMap.put("LimitLayout", ArrayUtils.asListArgs("onMeasure"));
        ignoreParamMap.put("LineHorizontalItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
        ignoreParamMap.put("LineItemDecoration", ArrayUtils.asListArgs("getItemOffsets","onDrawOver"));
