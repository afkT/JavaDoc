...
final class DevWidgetConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("StateLayout", ArrayUtils.asListArgs("reset","init","setListener","showIng","showFailed","showSuccess","showEmptyData","showType","notifyDataSetChanged","gone","visible","register","unregister","unregister","getAssistTag","setAssistTag","getData","setData","getData","setData","getView","getCurrentType","getCurrentView"));
