...
final class DevHttpCaptureCompilerConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreStaticMap() {
        ...
        ignoreStaticMap.put("UtilsCompiler", ArrayUtils.asListArgs("getManager","addActivity","removeActivity","finishAllActivity","createGson","toJsonIndent","toJsonIndent","fromJson","fromJson","putUrlFunction","removeUrlFunction","getUrlFunction","clearCallback","removeCallback","addCallback","notifyCallback","queryData","clearData","isQuerying","getMainData","getCaptureItemByDate","getFileData","getDateData","getUrlFunctionByInfo","getUrlFunctionByFile","getUrlFunctionByFile","resetRefreshClick","mapToString","mapToString"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("UtilsCompiler", ArrayUtils.asListArgs("getManager","addActivity","removeActivity","createGson","toJsonIndent","toJsonIndent","fromJson","fromJson","getUrlFunction","clearCallback","removeCallback","addCallback","notifyCallback","queryData","clearData","isQuerying","getMainData","getCaptureItemByDate","getFileData","getDateData","getUrlFunctionByInfo","getUrlFunctionByFile","getUrlFunctionByFile","resetRefreshClick","mapToString","mapToString"));
    ...
    public Map<String, List<String>> getIgnoreReturnVoidMap() {
        ...
        ignoreReturnVoidMap.put("UtilsCompiler", ArrayUtils.asListArgs("addActivity - void","removeActivity - void","finishAllActivity - void","putUrlFunction - void","removeUrlFunction - void","clearCallback - void","removeCallback - void","addCallback - void","notifyCallback - void","queryData - void","clearData - void","resetRefreshClick - void"));
