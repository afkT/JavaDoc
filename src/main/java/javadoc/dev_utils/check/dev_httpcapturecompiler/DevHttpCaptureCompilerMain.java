 ...
 * @author Ttt
 */
public class DevHttpCaptureCompilerMain {

    public static void main(String[] args) {
        // 检测路径
        String path = ApiConfig.DEV_HTTP_CAPTURE_COMPILER_PATH;
        // 代码检测分析配置接口
        ICheckConfig iCheckConfig = new DevHttpCaptureCompilerConfig();
        // 是否覆盖文件内容
        ...
        // 执行检测
        CheckMain.execute(DevHttpCaptureCompilerMain.class, new CheckInfo(path, iCheckConfig)
