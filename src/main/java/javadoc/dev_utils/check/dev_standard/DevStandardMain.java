...
class DevStandardMain {
    ...
    public static void main(String[] args) {
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodUnAnnotateMap, DevStandardConfig.sIgnoreAnnotateMap);
        // 转换 JSON 数据 - 缺少注释的方法
        ...
        // 忽略处理
        MapUtils.removeToMap(sParamUnFinalMap, DevStandardConfig.sIgnoreFinalMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodUnStaticMap, DevStandardConfig.sIgnoreStaticMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodLackParamMap, DevStandardConfig.sIgnoreParamMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodLackReturnMap, DevStandardConfig.sIgnoreReturnMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodUnPublicMap, DevStandardConfig.sIgnoreUnPublicMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sNoModifierVariableMap, DevStandardConfig.sIgnoreModifierVariableMap);
        ...
        // 忽略处理
        MapUtils.removeToMap(sMethodReturnVoidMap, DevStandardConfig.sIgnoreReturnVoidMap);
