...
final class DevStandardConfig implements ICheckConfig {
    ...
    public Map<String, List<String>> getIgnoreAnnotateMap() {
        ...
        ignoreAnnotateMap.put("CommonAbleMain", ArrayUtils.asListArgs("main","returnGetAbleAnnotation","getIgnoreAbleCLass"));
        ...
        ignoreAnnotateMap.put("FinalSortMain2", ArrayUtils.asListArgs("main"));
    ...
    public Map<String, List<String>> getIgnoreFinalMap() {
        ...
        ignoreFinalMap.put("CommonAbleMain", ArrayUtils.asListArgs("main"));
        ...
        ignoreFinalMap.put("FinalSortMain2", ArrayUtils.asListArgs("main"));
    ...
    public Map<String, List<String>> getIgnoreParamMap() {
        ...
        ignoreParamMap.put("CommonAbleMain", ArrayUtils.asListArgs("main"));
        ...
        ignoreParamMap.put("FinalSortMain2", ArrayUtils.asListArgs("main"));
    ...
    public Map<String, List<String>> getIgnoreUnPublicMap() {
        ...
        ignoreUnPublicMap.put("CommonAbleMain", ArrayUtils.asListArgs("returnGetAbleAnnotation","getIgnoreAbleCLass"));
