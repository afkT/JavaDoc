 ...
 * @author Ttt
 */
public class DevHttpCaptureMain {

    public static void main(String[] args) {
        // 检测路径
        String path = ApiConfig.DEV_HTTP_CAPTURE_PATH;
        // 代码检测分析配置接口
        ICheckConfig iCheckConfig = new DevHttpCaptureConfig();
        // 是否覆盖文件内容
        ...
        // 执行检测
        CheckMain.execute(DevHttpCaptureMain.class, new CheckInfo(path, iCheckConfig)
